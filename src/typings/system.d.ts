  ...
  interface Schema {
    ...
    login: {
      ...
      registerTips: {
        ...
        confirmPwdTips: string;
        notMatchPwdTips: string;
    ...
    themeConfig: {
      ...
      InterfaceFunction: {
        ...
        scrollMode: string;
        FixedHeader: string;
        TopMenuLocation: string;
        headHeight: string;
        tabHeight: string;
        tabCache: string;
        sidebarWidth: string;
        sidebarMixedWidth: string;
        showFooter: string;
        fixedFooter: string;
        bottomRight: string;
      };
      InterfaceDisplay: {
        title: string;
        breadCrumbs: string;
        breadCrumbsIcons: string;
        multipleTabs: string;
        multipleTabsStyle: string;
        pageSwitchAnimate: string;
        pageSwitchAnimateType: string;
      };
      themeConfig: {
        title: string;
        copyTheme: string;
