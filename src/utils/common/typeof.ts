...
export function isNullOrWhitespace<T extends undefined>(value: T | unknown): value is T {
  return getDataTypeString(value) === dataTypeLabels.null || getDataTypeString(value) === dataTypeLabels.undefined;
}
